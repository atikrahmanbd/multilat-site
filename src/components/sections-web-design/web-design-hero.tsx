...
export function WebDesignHero() {
  const features = [
    { icon: Smartphone, text: "Mobile-First", color: "green" },
    { icon: Eye, text: "Modern UI/UX", color: "purple" },
    { icon: Zap, text: "Lightning Fast", color: "yellow" },
    { icon: Laptop, text: "Responsive Design", color: "blue" },
  ];
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            >
              <h1 className="mb-3 sm:mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold px-2">
                <GradientText>Professional Web Design & Development</GradientText>
              </h1>
              <p className="mb-8 sm:mb-12 max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed px-4">
                We Build Beautiful, High-Performing Web Applications With Modern Technologies That Convert Visitors Into Customers And Drive Business Growth
              </p>
