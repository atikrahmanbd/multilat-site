...
import { Server, FileText, MessageSquare } from "lucide-react";
...
export function CloudVpsWhatsNext() {
  return (
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          ...
          <p className="px-4 mb-6 sm:mb-8 md:mb-12 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground md:text-xl leading-relaxed">
            Ready To Deploy Your Cloud VPS? Choose Your Next Step
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-w-5xl mx-auto">
          <Card
            ...
            description="Choose A Plan And Deploy Your Cloud VPS In Minutes."
          >
            <CanvasRevealEffect
              animationSpeed={5.1}
          ...
          <Card
            ...
            description="Learn How To Configure And Manage Your VPS Server."
          >
            <EvervaultCard text="" />
          </Card>
          <Card
