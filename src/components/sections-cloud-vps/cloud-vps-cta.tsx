...
import { MessageCircle, Mail, Users, Server, Headphones } from "lucide-react";
import {
  BorderMagicButton,
            ...
            <div className="p-8 sm:p-10 md:p-12 text-center">
              ...
              <div className="mb-8">
                <h2 className="mb-3 sm:mb-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-700 dark:text-slate-300">
                  <GradientText>Need Help Choosing A VPS Plan?</GradientText>
                </h2>
                <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  Our Expert Team Can Help You Find The Perfect VPS Configuration
              ...
              <div className="-mt-24 relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm text-muted-foreground">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p>Tailored VPS Configurations</p>
                  </div>
                  <div className="flex flex-col items-center">
                    ...
                    <p>Experienced Cloud Engineers</p>
                  </div>
                </div>
              </div>
            </div>
