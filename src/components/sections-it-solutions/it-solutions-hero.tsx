...
export function ItSolutionsHero() {
  const features = [
    { icon: Server, text: "Custom Software", color: "blue" },
    { icon: Cloud, text: "Cloud Solutions", color: "purple" },
    { icon: Shield, text: "IT Security", color: "yellow" },
    { icon: Cog, text: "System Integration", color: "green" },
  ];
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            >
              <h1 className="mb-3 sm:mb-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold px-2">
                <GradientText>IT & Custom Software Solutions</GradientText>
              </h1>
              <p className="mb-8 sm:mb-12 max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed px-4">
                Tailored Technology Solutions To Optimize Your Business Operations And Drive Digital Transformation
              </p>
