...
import { Search, FileCheck, Wrench, Headphones } from "lucide-react";
...
const processSteps = [
  {
    ...
    title: "Analysis",
    description:
      "We Assess Your Current Systems, Identify Pain Points, And Define Technical Requirements.",
    icon: Search,
    color: "blue",
  },
  {
    ...
    title: "Planning",
    description:
      "Creating Detailed Solutions Architecture, Timeline, And Resource Allocation Strategy.",
    icon: FileCheck,
    color: "purple",
  },
  {
    ...
    description:
      "Executing The Solution With Best Practices, Testing, And Quality Assurance.",
    icon: Wrench,
    color: "green",
  },
  {
    ...
    title: "Support",
    description:
      "Ongoing Maintenance, Monitoring, And Technical Support To Ensure Smooth Operations.",
    icon: Headphones,
    color: "yellow",
  },
];

export function ItSolutionsProcess() {
  return (
      ...
      <div className="relative z-20 mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="mb-3 sm:mb-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-700 dark:text-slate-300 px-2">
            <GradientText>Our Implementation Process</GradientText>
          </h2>
          <p className="px-4 mb-6 sm:mb-8 max-w-3xl mx-auto text-base sm:text-lg text-muted-foreground md:text-xl leading-relaxed">
            A Structured Approach To Deliver Reliable IT Solutions That Meet Your Goals
          </p>
        </div>
